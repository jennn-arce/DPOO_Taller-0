...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s de un atleta (MODIFICACI�N TALLER 0)");
		System.out.println("14. Salir de la aplicación\n");
	}


	/**
	 * !!MODIFICACI�N TALLER 0
	 * Se pregunta al usuario el nombre de un atleta para as� buscarlo
	 */	
	
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "B�squeda del pa�s de un atleta" + "\n");

		String nombreAtleta = input("Ingrese el nombre del atleta ");
		String paisAtleta = calculadora.paisAtleta(nombreAtleta);
		if (paisAtleta == "NA")
		{
			System.out.println("El nombre del atleta y/o su pa�s no fue encontrado");
		}
		else
		{
			System.out.println("El pa�s del atleta con nombre: "+nombreAtleta+" es: " + paisAtleta);
		}
